...
import { Theme, ThemeContext, LOCAL_STORAGE_THEME_KEY, ThemeColor, LOCAL_STORAGE_THEME_COLOR_KEY, ThemeContextProps } from './ThemeContext'
...
export function useTheme (): UseThemeResult {
  ...
  return { theme: theme || Theme.LIGHT, toggleTheme, themeColor: themeColor || ThemeColor.BLUE, toggleThemeColor }
}
