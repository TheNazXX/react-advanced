...
export const EditWord: FC<EditWordProps> = ({ className, word }) => {
  ...
  const [transtaltionWordValue, setTranslationWordValue] = useState<string>(
    word.translate.join(", ")
  );
      ...
      <div className="flex-between">
        <div className={cls.group}>
          ...
          <Input
            ...
            value={upperFirstLetter(enWordValue)}
      ...
      <div className={classNames(cls.group, {}, [cls.sentences])}>
        ...
        <div className={cls.group_row}>
          <Textarea
            ...
            value={sentences[activeSentence]?.en}
            onChange={() => {}}
          ...
          <Textarea
            className="animate__animated animate__fadeIn"
            typeTextarea={TypeTextarea.SECONDARY}
            value={sentences[activeSentence]?.translate}
            onChange={() => {}}
