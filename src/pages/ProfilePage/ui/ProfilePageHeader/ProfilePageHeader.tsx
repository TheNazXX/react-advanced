...
export const ProfilePageHeader: FC<ProfilePageHeaderProps> = ({
  ...
  const onSave = useCallback(() => {
    const { isErrors, errors } = getValidationErrors(
  ...
  const getValidationErrors = (
    requiredFields: requiredValidationFields,
    data: ProfileInterface | undefined
  ) => {
    const errors: any = {};
    ...
    if (data) {
      Object.entries(requiredFields).forEach(([key, value]) => {
        const fieldErrors = validation(data[key] as string, {
          [Rules.REQUIRED]: true,
        });
      ...
      <div className={classNames(cls.ProfilePageHeader, {}, [className])}>
        ...
        {readonly ? (
          ...
          <div className={cls.btns}>
            <Button
              className={classNames(cls.btn_cancel, {}, [
                "animate__animated animate__fadeIn animate__faster",
              ])}
            ...
            <Button
              className={classNames(cls.btn_save, {}, [
                "animate__animated animate__fadeIn animate__faster",
              ])}
